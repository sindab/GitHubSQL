...
/* BACKUP */
print 'backup'
BACKUP DATABASE [EC201001] TO  DISK = N'D:\EASTCODE\EC201001.bak' WITH  INIT ,  NOUNLOAD ,  NAME = N'EC201001 backup',  NOSKIP ,  STATS = 10,  NOFORMAT 
go

print 'brisem nove dokumente u staroj godini'
DELETE FROM [EC201001].[dbo].[UlazIzlaz] WHERE DATEPART(year,Datum) <> 2010
go
DELETE FROM [EC201001].[dbo].[UlazIzlazDetalj] WHERE vID NOT IN (SELECT vID FROM UlazIzlaz)
go
DELETE FROM [EC201001].[dbo].[UlazIzlazSumm] WHERE vID NOT IN (SELECT vID FROM UlazIzlaz)
go
DELETE FROM [EC201001].[dbo].[UlazTrosak] WHERE vID NOT IN (SELECT vID FROM UlazIzlaz)
go
DELETE FROM [EC201001].[dbo].[Serijski] WHERE vID NOT IN (SELECT vID FROM UlazIzlaz)
go
DELETE FROM [EC201001].[dbo].[BarCodePopis] WHERE vID NOT IN (SELECT vID FROM [EC201001].[dbo].UlazIzlaz)
go
DELETE FROM [EC201001].[dbo].[BarCodeUI] WHERE vID NOT IN (SELECT vID FROM [EC201001].[dbo].UlazIzlaz)
go
...
/* RESTORE */
RESTORE DATABASE [EC201101] FROM  DISK = N'D:\EASTCODE\EC201001.bak' WITH  FILE = 1,  NOUNLOAD ,  STATS = 10,  RECOVERY ,  MOVE N'F001G040101M001_Data' TO N'D:\EASTCODE\DATA\EC201101.mdf',  MOVE N'F001G040101M001_Log' TO N'D:\EASTCODE\DATA\EC201101_log.ldf'
go
...
DELETE FROM [EC201001].[dbo].[GK] WHERE DATEPART(year, Datum) <> 2010
-- PS GK
...
DELETE FROM [EC201001].[dbo].[NalogS] WHERE DATEPART(YEAR, DokDatum)<>2010
DELETE FROM [EC201101].[dbo].[NalogS] WHERE DATEPART(YEAR, DokDatum)<>2011
DELETE FROM [EC201001].[dbo].[NalogG] WHERE vID not in (SELECT vID  FROM [EC201001].[dbo].[NalogS])
DELETE FROM [EC201101].[dbo].[NalogG] WHERE vID not in (SELECT vID  FROM [EC201101].[dbo].[NalogS])

/*
-- DELETE FROM [EC201001].[dbo].[NalogG] WHERE DATEPART(year, Datum) <> 2010
-- go
-- DELETE FROM [EC201001].[dbo].[NalogS] WHERE vID NOT IN (SELECT vID FROM [EC201001].[dbo].[NalogG])
-- go
...
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[UITable]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaGlava]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaGlava] WHERE DATEPART(year, Datum) <> 2011
--DELETE FROM [EC201101].[dbo].[KasaG] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG1]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG1] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG2]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG2] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG3]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG3] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG4]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG4] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG5]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG5] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG6]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG6] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG7]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG7] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG8]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG8] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG9]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG9] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG10]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG10] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG11]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG11] WHERE DATEPART(year, Datum) <> 2011
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaG12]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaG12] WHERE DATEPART(year, Datum) <> 2011

if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaStavka]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaStavka] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaGlava WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS1]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS1] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG1 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS2]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS2] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG2 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS3]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS3] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG3 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS4]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS4] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG4 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS5]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS5] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG5 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS6]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS6] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG6 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS7]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS7] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG7 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS8]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS8] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG8 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS9]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS9] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG9 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS10]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS10] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG10 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS11]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS11] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG11 WHERE DATEPART(year, Datum) = 2011)
if exists (select * from [EC201101].dbo.sysobjects where id = object_id(N'[KasaS12]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DELETE FROM [EC201101].[dbo].[KasaS12] WHERE vID NOT IN (SELECT vID FROM [EC201101].[dbo].KasaG12 WHERE DATEPART(year, Datum) = 2011)
